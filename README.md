...
=======
valac --pkg gtk+-3.0 --pkg gdk-x11-3.0 --pkg x11 --pkg json-glib-1.0 --pkg libwnck-3.0 -X -DWNCK_I_KNOW_THIS_IS_UNSTABLE -X -lm main.vala config.vala animation.vala dock_window.vala x11_utils.vala
>>>>>>> 3314aaa7f6bbacc96aed184111f11e09fdcf48e6
```
